namespace Store.Sharing.Constants
{
    public partial class Constants
    {
        public class Error
        {
            ...
            public const string ERROR = "/Error"; //TODO never used constant
            public const string NO_ORDERS_IN_DB = "no any orders in DB";//TODO never used constant
            public const string NO_ORDERS_THIS_ID = "no any orders in DB with this ID";
            public const string NO_ANY_PROP_NAME = "no any property with this name";//TODO never used constant
            public const string WRONG_CONDITIONS_EDITION = "no any editions in db with this conditions";//TODO never used constant
            public const string WRONG_CONDITIONS_ORDER = "no any orders in db with this conditions";//TODO never used constant
            ...
            public const string WRONG_PASSWORD = "Wrong current password";//TODO never used constant
            public const string PASSWORD_IN_USE = "New password is in use. Choose other password";//TODO never used constant
            ...
            public const string LOGIN_FAILD_MODEL = "login faild - model is NULL";//TODO never used constant
            public const string LOGIN_FAILD_EMAIL = "login faild - no user with this email";//TODO never used constant
            ...
            public const string REGISRATION_FAILD_NAME_IN_USE = "regisration faild this name is already in use";//TODO never used constant
            ...
            public const string EMAILCONFIRM_CODE_NULL = "emailConfirmationModel - code is null";//TODO never used constant
            ...
            public const string NO_USER_THIS_CONDITIONS = "no user in DB with this conditions";//TODO never used constant
