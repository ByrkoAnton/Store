...
namespace Store.Sharing.Constants
{
    public partial class Constants
    {
        public class Error
        {
            public const string NO_ANY_ORDERITEMS_IN_DB = "no any orderItems in DB";
            ...
            public const string NO_ANY_ORDERITEMS_IN_DB_WITH_THIS_ID = "no any orderitems in DB with this ID";
