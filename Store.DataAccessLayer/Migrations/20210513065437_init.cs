    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2021, 5, 13, 9, 54, 34, 210, DateTimeKind.Local).AddTicks(7755), "FirstAuthor" });

            migrationBuilder.InsertData(
                table: "PrintingEditions",
                columns: new[] { "Id", "Currency", "DateOfCreation", "Description", "IsRemoved", "Prise", "Status", "Type" },
                values: new object[] { 1L, 5, new DateTime(2021, 5, 13, 9, 54, 34, 214, DateTimeKind.Local).AddTicks(1487), "FirstEdition", false, 5.0, "Avalible", 0 });
